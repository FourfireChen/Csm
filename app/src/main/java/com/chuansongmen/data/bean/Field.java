...
public class Field {
    ...
    public static final String ROUTE_WORKER_ID = "route_worker_id";
    public static final String ROUTE_NAME = "route_name";
    public static final String ROUTE_WORKER_NAME = "route_worker_name";
    ...
    public static final String WORKER_SEX = "worker_sex";
    ...
    public static final String WORKER_CATEGORY = "category";
