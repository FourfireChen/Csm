...
public class PermissionUtil {
    public static boolean permissionsCheckAndRequest(Fragment fragment, int requestCode, String... perms) {
    ...
    public static boolean permissionsCheckAndRequest(Activity activity, int requestCode, String... perms) {
